...
export const ContactCard = ({ phone, email }: { phone: string, email: string }) => {
  return (    <div className='flex flex-col items-center sm:mt-10 lg:mt-0 h-fit p-5 md:px-10 md:pt-5 md:pb-10 bg-gray-100 border-[3px] border-solid border-gray-400 rounded-md shadow-[0+4px_14px_#9ca3af]'>
